...
class ElasticNetModel(MachineLearningModel):
    ...
    def __init__(self, x, y, y_names, verbosity, grid_search, **kwargs):
        ...
        super().__init__(
            x, y, y_names, hyperparameters=hyperparameters, verbosity=verbosity, pretty_name = 'Elastic Net', model_type='classification', **kwargs)
...
class LogisticRegressionModel(MachineLearningModel):
    ...
    def __init__(self, x, y, y_names, verbosity, grid_search, **kwargs):
        ...
        super().__init__(
            x, y, y_names, hyperparameters=hyperparameters, pretty_name = 'Logistic Regression', verbosity=verbosity, model_type='classification', **kwargs)
