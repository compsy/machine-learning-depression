...
class TestObjectCacher():
    ...
    def test_can_write_test_data(self, subject):
        data = {'a':1}
        subject.write_cache(data, 'data_examples/test_cache')
        assert subject.file_available('data_examples/test_cache')

    def test_can_read_test_data(self, subject):
        data = {'a':1}
        cache_file = 'data_examples/test_cache'
    ...
    def test_available_can_check_with_or_without_adding_a_dir(self, subject):
        ...
        cache_file = 'tests/data_examples/test_cache'
